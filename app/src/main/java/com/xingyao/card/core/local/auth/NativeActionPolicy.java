...
public final class NativeActionPolicy {
    ...
    static {
        ...
        publicActions.add("device.activate");
        ...
        publicActions.add("tts.speak");
        publicActions.add("app.restartStatus");
        publicActions.add("app.updateInfo");
        publicActions.add("app.updateStatus");
        publicActions.add("app.downloadUpdate");
        publicActions.add("app.installUpdate");
        publicActions.add("diagnostics.log.write");
        publicActions.add("diagnostics.log.setUploadEnabled");
        ...
        permissions.put("serial.disconnect", "debug.command");
        permissions.put("serial.setPolling", "settings.basic");
        permissions.put("serial.setDebugLogging", "debug.command");
        permissions.put("serial.setLedDutyCycle", "debug.command");
        permissions.put("serial.listPorts", "settings.basic");
        permissions.put("serial.send", "debug.command");
        permissions.put("serial.openDoor", "debug.command");
        permissions.put("serial.querySlot", "debug.command");
        permissions.put("serial.readVersion", "debug.command");
        permissions.put("serial.openAllDoors", "debug.command");
        permissions.put("serial.firmwareUpgrade", "upgrade.firmware");
        permissions.put("serial.cancelFirmwareUpgrade", "upgrade.firmware");
        ...
        permissions.put("employee.sync", "employee.view");
